...
| [ComfyUI-AuraSR](https://github.com/GreenLandisaLie/AuraSR-ComfyUI)                 | AuraSR: GAN-based Super-Resolution for real-world.                                | [AnyText](https://github.com/fal-ai/aura-sr)               |  |
| [ComfyUI_CatVTON](https://github.com/chflame163/ComfyUI_CatVTON_Wrapper)                 | CatVTON: Concatenation Is All You Need for Virtual Try-On with Diffusion Models.                                | [CatVTON](https://github.com/Zheng-Chong/CatVTON)               |[arXiv](https://arxiv.org/abs/2407.15886)  |
...
| [ComfyUI-IMAGDressing](https://github.com/AIFSH/IMAGDressing-ComfyUI)                          | IMAGDressing👔: Interactive Modular Apparel Generation for Virtual Dressing.                                                                    | [IMAGDressing](https://github.com/muzishen/IMAGDressing)               |[arXiv](https://arxiv.org/abs/2407.12705)  |
...
| [ComfyUI-Kolors](https://github.com/kijai/ComfyUI-KwaiKolorsWrapper)                           | Kolors: Effective Training of Diffusion Model for Photorealistic Text-to-Image Synthesis.                                                            | [Kolors](https://github.com/Kwai-Kolors/Kolors)    |         |
...
| [ComfyUI_MagicClothing](https://github.com/frankchieng/ComfyUI_MagicClothing)                                  | Magic Clothing: Controllable Garment-Driven Image Synthesis.                                            | [Magic Clothing](https://github.com/ShineChen1024/MagicClothing)                   |[arXiv](https://arxiv.org/abs/2404.09512)  |
...
| [comfyui-reactor-node](https://github.com/Gourieff/comfyui-reactor-node)                        | Fast and Simple Face Swap Extension Node for ComfyUI.                                               |            |   |
...
| [ComfyUI-Segment-Anything-2](https://github.com/kijai/ComfyUI-segment-anything-2)              | SAM 2: Segment Anything in Images and Videos.                                | [Segment Anything Model 2 (SAM 2)](https://github.com/facebookresearch/segment-anything-2)         |[arXiv](https://arxiv.org/abs/2408.00714)  |
...
| [DiffMorpher-ComfyUI](https://github.com/AIFSH/DiffMorpher-ComfyUI)                            | DiffMorpher: Unleashing the Capability of Diffusion Models for Image Morphing.                                          | [DiffMorpher](https://github.com/Kevin-thu/DiffMorpher)           |[arXiv](https://arxiv.org/abs/2312.07409)  |
...
| ComfyUI                                                                                      | Description                                                                                                                                                                                    |   Source   |   Paper   |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------: | :-------: |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [CharacterGen](https://github.com/zjp-shadow/CharacterGen)            |[arXiv](https://arxiv.org/abs/2402.17214)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [CRM](https://github.com/thu-ml/CRM)            |[arXiv](https://arxiv.org/abs/2403.05034)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [Era3D](https://github.com/pengHTYX/Era3D)            |[arXiv](https://arxiv.org/abs/2405.11616)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [InstantMesh](https://github.com/TencentARC/InstantMesh)            |[arXiv](https://arxiv.org/abs/2404.07191)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [Stable Fast 3D](https://github.com/Stability-AI/stable-fast-3d)            |[arXiv](https://arxiv.org/abs/2408.00653)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [Unique3D](https://github.com/AiuniAI/Unique3D)            |[arXiv](https://arxiv.org/abs/2405.20343)  |
| [ComfyUI-3D-Pack](https://github.com/MrForExample/ComfyUI-3D-Pack)                  | Make 3D assets generation in ComfyUI good and convenient as it generates image/video!                                                                 | [Zero123++](https://github.com/SUDO-AI-3D/zero123plus)            |[arXiv](https://arxiv.org/abs/2310.15110)  |
...
| [ComfyUI-AnimateAnyone-Evolved](https://github.com/MrForExample/ComfyUI-AnimateAnyone-Evolved)      | Animate Anyone: Consistent and Controllable Image-to-Video Synthesis for Character Animation.                                       | [Animate Anyone](https://github.com/HumanAIGC/AnimateAnyone)              |[arXiv](https://arxiv.org/abs/2311.17117)  |
...
| ComfyUI                                                                                      | Description                                                                                                                                                                                    |   Source   |   Paper   |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-----------: | :-------: |
| [ComfyUI-DiffSynth-Studio](https://github.com/AIFSH/ComfyUI-DiffSynth-Studio)                          | Diffutoon: High-Resolution Editable Toon Shading via Diffusion Models.                                                               | [Diffutoon](https://github.com/modelscope/DiffSynth-Studio)      |[arXiv](https://arxiv.org/abs/2401.16224)  |
| [ComfyUI-MagicAnimate](https://github.com/thecooltechguy/ComfyUI-MagicAnimate)                          | MagicAnimate: Temporally Consistent Human Image Animation using Diffusion Model.                                                     | [MagicAnimate](https://github.com/magic-research/magic-animate)      |[arXiv](https://arxiv.org/abs/2311.16498)  |
| [ComfyUI-MimicMotion](https://github.com/AIFSH/ComfyUI-MimicMotion)                          | MimicMotion: High-Quality Human Motion Video Generation with Confidence-aware Pose Guidance.                                                               | [MimicMotion](https://github.com/Tencent/MimicMotion)      |[arXiv](https://arxiv.org/abs/2406.19680)  |
...
| [ComfyUI_EchoMimic](https://github.com/smthemex/ComfyUI_EchoMimic)                             | EchoMimic: Lifelike Audio-Driven Portrait Animations through Editable Landmark Conditioning.                     | [EchoMimic](https://github.com/BadToBest/EchoMimic)           |[arXiv](https://arxiv.org/abs/2407.08136)  |
| [ComfyUI-Hallo](https://github.com/AIFSH/ComfyUI-Hallo)                          | Hallo: Hierarchical Audio-Driven Visual Synthesis for Portrait Image Animation.                                                               | [Hallo](https://github.com/fudan-generative-vision/hallo)      |[arXiv](https://arxiv.org/abs/2406.08801)  |
...
| [ComfyUI-LivePortraitKJ](https://github.com/kijai/ComfyUI-LivePortraitKJ)                                      | LivePortrait: Efficient Portrait Animation with Stitching and Retargeting Control!                                                              | [LivePortrait](https://github.com/KwaiVGI/LivePortrait)              |[arXiv](https://arxiv.org/abs/2407.03168)  |
